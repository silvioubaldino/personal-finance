...
var (
	...
	ErrTransferMustUsePairEndpoint     = errors.New("internal transfer movements must be updated, deleted or settled via the transfer endpoint")
	ErrTransferPairInconsistentPayment = errors.New("internal transfer pair has legs with different payment states")
	...
	ErrMPCrossCountry           = errors.New("mercado pago cross-country restriction")
