...
func (uc categoryUseCase) Update(ctx context.Context, id uuid.UUID, category domain.Category) (domain.Category, error) {
	result, err := uc.repo.Update(ctx, id, category)
	if err != nil {
